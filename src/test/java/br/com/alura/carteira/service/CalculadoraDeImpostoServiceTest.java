...
class CalculadoraDeImpostoServiceTest {
	...
	private Transacao criarTransacao(BigDecimal preco, Integer quantidade, TipoTransacao tipo) {
		Transacao transacao = new Transacao(
				...
				LocalDate.now(),
				tipo,
				new Usuario(1l, "rafaela", "rafaela@rafaela.com", "123456", "rafaela@rafaela.com", null),
				BigDecimal.ZERO
				);
		return transacao;
	}
	...
	@Test
	void transacaoDoTipoVendaMenorDoQueVinteMilNaoDeveriaTerImposto() {
	...
	@Test
	void transacaoDoTipoVendaNaoDeveriaTerImposto() {
		Transacao transacao = criarTransacao(new BigDecimal("30.00"), 10, TipoTransacao.VENDA);
	...
	@Test
	void deveriaCalcularImpostoDoTipoVendaComValorMaiorQueVinteMil() {
